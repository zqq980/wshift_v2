...
class Mutator {
    public static void main(String[] argv) {
        String whoami = "Mutator"; // What's the name of this application?
...
// If Mutator.class isn't writeable, then forget the whole deal.
...
// Report how many times the Mutator has been run before this time.
        ...
        System.out.println("The Mutator has already been run " + num_runs +
                           " time(s).");
// If it's already been run 5 times, then get rid of Mutator.class

...
public class URLConnectionTest
{
   ...
   public URLConnectionTest(String urlName, String username, String password) {
   ...
   public static void main(String[] args) {
      ...
      if (args.length > 0)  {
         ...
         urlName = "http://www.webjb4.org/webjb/viewtopic2.php?topic=10228600&forum=01";
      }
      ...
      URLConnectionTest urlConnectionTest =  new URLConnectionTest(urlName, username, password);
   }

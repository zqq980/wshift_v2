...
public class ScienceFair {
	...
	public static void main(String[] args) {
		...
		String[] algortithmStr = {"Selection sort",
			"Insertion sort",
			"Bubble sort",
			"Quick sort",
			"Merge sort",
		...
		System.out.println();
		System.out.println(" is =  " + is + " ia= " + ia);
		...
		for (c = 0; c < sortedArray.length; c++)
        ...
        for(int ia = 0; ia < algortithmStr.length; ia ++) {
        	System.out.print(algortithmStr[ia] + ", ");
        }
        System.out.println();
